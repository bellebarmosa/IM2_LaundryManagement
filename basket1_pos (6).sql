...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2023 at 03:24 AM
...
(4, 'Sam Son', '02341', 'SamSon@gmail.com'),
(5, 'Bob Smith', '01234', 'BobSmith@gmail.com'),
(6, 'Emily White', '06789', 'EmilyWhite@gmail.com'),
(7, 'David Brown', '03451', 'DavidBrown@gmail.com');
...
(6, 'admin', '092131231', 'admin@admin', 'admin', '$2b$10$QGrbhK0hBRS2iTfHRADDT.6TC0EJthjf0fpPZEqEKYf6C50P2k22i'),
(7, 'Eva Martinez', '555-4321', 'eva.martinez@example.com', 'service', '$2b$10$Y71vXNykWv6VXG1jtfCHn.73IzQPIAk6iyz1H1QX0CFUh/rinu4Hy'),
(8, 'Bob Smith', '555-9876', 'bob.smith@example.com', 'cashier', '$2b$10$vETdJ/nkHRxYagxk4ee7Wu6B3mhmZXuOrD7k/inWyRBA/Uk91t.8S'),
(9, 'Alice John', '555-5678', 'alice.johnson@example.com', 'service', '$2b$10$yz6XFCjJWHPBOB6nnAgwiuIGUaSQ9KIjdVwrwx39AiokDZt1JY/n6'),
(10, 'Kyle', '2131', 'me@emaikl', 'Cashier', '$2b$10$E4X.dIoA/G2jkuJGZ2EiVe5Fuc7XwL2QWjzCLlI14dxmlKEgR3Wqa');
...
(72, 71, 0.00, 0.00, 1, 'Weight'),
(73, 71, 1.00, 150.00, 2, 'Piece'),
(74, 72, 5.00, 250.00, 4, 'Weight'),
(75, 72, 1.00, 150.00, 5, 'Piece');
...
(69, 1, 6, 'Processing', '2023-12-06', '2023-12-06', 421.00, 511.00, NULL, NULL),
(70, 3, 6, 'Pending', '2023-12-05', '2023-12-04', 335.00, 400.00, NULL, NULL),
(71, 1, 6, 'Pending', '2023-12-06', '2023-12-09', 150.00, 200.00, NULL, NULL),
(72, 3, 6, 'Pending', '2023-12-06', '2023-12-09', 400.00, 500.00, NULL, NULL);
...
(5, 'Fluff and fold', 'y', 50.00),
(6, 'Curtain Wash(W/OUT RINGS)', 'wada', 60.00),
(12, 'SAMPLE', 'DELETEME ', 12.00);
...
--
ALTER TABLE `orderdetails`
  MODIFY `OrderDetails_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
