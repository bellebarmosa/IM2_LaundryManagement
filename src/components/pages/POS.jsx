...
const POS = () => {
  ...
  useEffect(() => {
    ...
    const fetchservices = async () => {
      try {
        ...
        console.error('Error fetching services states:', error);
        // Handle errors here
      }
    };
  ...
  useEffect(()=>{
    if(priceList && services && ClothesType){
      const generatePriceList = (clotheTypes, services, priceList) => {
      ...
      // Example usage
      const formattedPriceList = generatePriceList(ClothesType, services, priceList);
      setPriceList(formattedPriceList)
       console.log(formattedPriceList);
    }
  },[ClothesType, services, priceList])
  ...
  const addLaundryItems = (items) => {
     ...
     const newItem_ID = ClothesType.find((clotheType)=>clotheType.name === items.type);
    //  console.log(newItem_ID);
    const newService_ID = services.find((service)=>service.service_name == items.service);


     const newItem = {...items,type_ID:newItem_ID.clotheType_ID,service_ID:newService_ID.serviceType_ID}
  ...
  return (
    ...
    {showPaymentModal && (
      ...
      {ClothesType && PriceList && renderClothesTypeRows()}
    </div>
