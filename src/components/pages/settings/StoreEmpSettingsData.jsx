...
const StoreEmpSettingsData = () => {
  ...
  const handleEditClick = () => {
    setEditMode(true);
    setNewUsername(employeeProfile.username);
    setNewEmail(employeeProfile.email);
    setNewPhone(employeeProfile.phone);
    setNewPassword('');
    setConfirmPassword('');
  };
  ...
  const handleSaveChanges = () => {
    if (newPassword === confirmPassword) {
      console.log('Employee information updated:', { newUsername, newEmail, newPhone, newPassword });
      setEditMode(false);
      setNewUsername('');
      setNewEmail('');
      setNewPhone('');
  ...
  return (
    <div className="container mx-auto mt-8 p-8 bg-brightYellow rounded">
      <h2 className="text-2xl text-darkBlue font-bold mb-4">Employee Profile</h2>
...
export default StoreEmpSettingsData;
